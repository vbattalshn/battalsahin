	...
	<section id="my-project" class="container content-title myProjects-page">
		<div class="project-holder" v-for="(project, index) in projects" :key="index">
			...
			<div class="project-options">
				<a v-if="project.Github != '' || project.Github" :href="project.Github" title="Githubda görüntüle" class="github-link project-link">
				...
				<a v-if="project.Site != '' || project.Site" :href="project.Site" title="Ziyaret et" class="site-link project-link">
